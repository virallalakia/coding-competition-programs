...
/**
 * This is a solution for Square? Problem problem of Codeforces.
...
public class Square {
  ...
  private static void evaluateCase() {
    try {
      int a1 = SYS_IN.nextInt();
      int b1 = SYS_IN.nextInt();
      SYS_IN.nextLine();
      int a2 = SYS_IN.nextInt();
      int b2 = SYS_IN.nextInt();
      SYS_IN.nextLine();

      System.out.println(
        (Math.max(a1, b1) == Math.max(a2, b2)
          && Math.max(a1, b1) == Math.min(a1, b1) + Math.min(a2, b2))
        ? "YES"
        : "NO");
    } catch (Exception e) {}
  }
